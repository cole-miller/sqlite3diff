...
fn main() {
    ...
    let expected_delta_bytes = expected_delta_pages * PAGE_SIZE as u64;
    println!("Expected delta size: about {expected_delta_pages} pages, {expected_delta_bytes} bytes");
